...
func WithStrictValueMatcher(matcher cuepath.GlobMatcher) CueWriterOption {
	return func(cw *cueWriter) {
...
func Dump(value any, optFns ...CueWriterOption) ([]byte, error) {
...
type cueWriter struct {
	...
	strictValueMatcher cuepath.GlobMatcher
}
