...
//go:linkname newCodeRepo github.com/octohelm/cuekit/internal/gomod/internal/go/cmd/go/internals/modfetch.newCodeRepo
func newCodeRepo(code codehost.Repo, codeRoot, subdir, path string) (modfetch.Repo, error)

//go:linkname lookupCodeRepo github.com/octohelm/cuekit/internal/gomod/internal/go/cmd/go/internals/modfetch.lookupCodeRepo
